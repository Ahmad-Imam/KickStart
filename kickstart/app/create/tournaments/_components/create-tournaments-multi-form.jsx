      ...
      const handleRadioChangeGroupQ = (value) => {
        ...
        if (!validateGroups(formData.groupsNum, valueInt)) {
          ...
          setFormData((prevData) => {
            const newTeamsPerGroup =
              valueInt > prevData.teamsPerGroup
                ? valueInt
                : prevData.teamsPerGroup;
            return {
              ...prevData,
        ...
        const handleInputChange = (e) => {
          ...
          setFormData((prevData) => {
            if (
              name === "teamsPerGroup" &&
              valueInt < prevData.teamsQPerGroup
            ) {
              return {
                ...prevData,
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <TooltipProvider>
                          <Tooltip>
                            ...
                            <TooltipContent>
                              Number of Groups * Number of Teams Qualified must
                              be 8
                            </TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <TooltipProvider>
                            <Tooltip>
                              ...
                              <TooltipContent>
                                Number of Groups * Number of Teams Qualified
                                must be 4
                              </TooltipContent>
                            </Tooltip>
                          </TooltipProvider>
                  ...
                  <div className="grid w-full items-center gap-4">
                    <div className="flex flex-col items-start">
                      ...
                      <div className="flex flex-row flex-wrap gap-2 py-2">
                        {generateGroupLabels(formData.groupsNum).map(
                          (label) => (
                            <Badge
