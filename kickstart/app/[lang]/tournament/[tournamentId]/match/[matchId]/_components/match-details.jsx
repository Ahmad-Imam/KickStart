...
import MatchSheet from "@/app/[lang]/tournament/[tournamentId]/match/[matchId]/_components/MatchSheet";
import { getTeamsTByTeamId } from "@/queries/teams";
import MatchSettings from "@/app/[lang]/tournament/[tournamentId]/match/[matchId]/_components/MatchSettings";
      ...
      <div className="flex flex-row justify-between">
        <div className="w-min">
          <Link
            ...
            passHref
          >
            <div className="customButton my-4 ">{wordDb.backToTournament}</div>
          </Link>
        </div>
        {isAdmin && tournament?.status === "upcoming" && (
          <div>
            <Link
              ...
              passHref
            >
              <div className="customButton my-4 ">{wordDb.editMatch}</div>
            </Link>
          </div>
        )}
      </div>
